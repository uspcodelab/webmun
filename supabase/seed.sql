...
values
	...
	$$
    	[
            ...
            { "id": 2, "seat": "3-2", "name": "Brasil", "code": "br" }
		]
	$$
	);
...
-- we got back to a simple table creation
insert into public.session_assignments
	(user_id, session_id, role, delegation_id)
values
	('11111111-1111-1111-1111-111111111111', 1, 'CHAIR', null),
	('22222222-2222-2222-2222-222222222222', 1, 'DELEGATE', 0),
	('33333333-3333-3333-3333-333333333333', 1, 'DELEGATE', 1),
	('44444444-4444-4444-4444-444444444444', 1, 'DELEGATE', 2);
