    ...
    return (
        <div className="flex min-h-0 flex-col">
            ...
            <div className="mx-4">
                ...
                <div className="mb-4 flex flex-col gap-2">
                    ...
                    >
                        ...
                        <div
                            ...
                            title={`Maioria necessaria: ${requiredMajority} votos`}
                            aria-label={`Maioria necessaria: ${requiredMajority} votos`}
                        />
                    </div>
                ...
                <p className="text-muted-foreground flex justify-center mb-4">{majorityType}: {requiredMajority} votos</p>
